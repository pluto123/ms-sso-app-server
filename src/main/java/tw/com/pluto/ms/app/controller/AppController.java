package tw.com.pluto.ms.app.controller;
...
import tw.com.pluto.ms.app.config.AccessToken;
...
public class AppController extends WebSecurityConfigurerAdapter {
    ...
    public String loadProfiles(Model model) {
        ...
        try {
            ResponseEntity<Customer[]> responseEntity = restTemplate.exchange("http://localhost:8181/services/profiles",
